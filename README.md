...
**Retained failures.** The Bus was retired after a prior-art sweep invalidated 17 of its assumptions; the retraction ledger is public. SEED keeps a retractions file for numbers that were published and are now known false.
